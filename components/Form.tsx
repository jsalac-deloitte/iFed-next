        ...
        <div className="bg-black bg-opacity-50 w-screen md:w-[480px] h-screen md:h-[450px] md:rounded-[25px] md:backdrop-blur-[10px] flex flex-col items-center justify-center">
            ...
            <form action="submit" className={displayLogin === true ? "block" : "hidden"}>
                <div className="flex flex-col items-center md:m-auto md:w-[360px]">
                    <label htmlFor="emailLogin" className="relative mt-[30px] md:mt-[50px]">
                        <MdMailOutline className="pointer-events-none w-[20px] h-[20px] absolute top-1/2 transform -translate-y-1/2 left-[15px] fill-white opacity-50" />
                    ...
                    <label htmlFor="passwordLogin" className="relative mt-[30px] md:mt-[50px]">
                        <MdLockOutline className="pointer-events-none w-[20px] h-[20px] absolute top-1/2 transform -translate-y-1/2 left-[15px] fill-white opacity-50" />
                        ...
                        {displayPassword === false ? (
                            <MdOutlineVisibilityOff onClick={passwordInput} className="cursor-pointer w-[20px] h-[20px] absolute top-1/2 transform -translate-y-1/2 right-[15px] fill-white opacity-50" />
                        ) : (
                            <MdOutlineVisibility onClick={passwordInput} className="cursor-pointer w-[20px] h-[20px] absolute top-1/2 transform -translate-y-1/2 right-[15px] fill-white opacity-50" />
                        )}
                    </label>
            ...
            <form action="submit" className={displayRegister === true ? "flex flex-col items-center mt-[32px]" : "hidden"}>
                <label htmlFor="firstName" className="relative">
                    <MdOutlineBadge className="pointer-events-none w-[20px] h-[20px] absolute top-1/2 transform -translate-y-1/2 left-[15px] fill-white opacity-50" />
                ...
                <label htmlFor="passwordRegister" className="relative">
                    <MdLockOutline className="cursor-pointer w-[20px] h-[20px] absolute top-1/2 transform -translate-y-1/2 left-[15px] fill-white opacity-50" />
                ...
                <label htmlFor="contact" className="relative">
                    <MdOutlinePhone className="pointer-events-none w-[20px] h-[20px] absolute top-1/2 transform -translate-y-1/2 left-[15px] fill-white opacity-50" />
                ...
                <div className="md:w-[360px] flex justify-end">
                    <button className="flex justify-center items-center mt-[32px] w-[275px] md:w-[150px] rounded-[25px] bg-[#80B324] bg-opacity-50 transition hover:bg-opacity-100 text-[16px] text-white text-opacity-75">REGISTER <MdChevronRight className="w-[40px] h-[40px]" /></button>
                </div>
            </form>
        </div >
    )
