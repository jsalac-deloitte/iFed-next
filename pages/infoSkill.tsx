...
const infoSkill: NextPage = () => {
  return (
    <div>
      ...
      <div className="bg-green-500 h-[72px]">arnoold</div>
      <main>
        <div className="flex justify-center">
          <div>
            <button
              className="   bg-[#BBBCBC]   hover:bg-[#393939] hover:text-white
                   text-black w-[125px]
                    h-[70px] text-[24px] font-bold text-center
                    rounded-l-[10px] mt-[30px] mx-auto py-[11px]"
            >
              Industries
            </button>
            <button
              className="  bg-[#BBBCBC]  hover:bg-[#393939]
             hover:text-white text-black w-[125px]
                 h-[70px] text-[24px] font-bold text-center rounded-r-[10px]
                  mt-[30px] mx-auto py-[11px]"
            >
              <span className="text-center m-2 pt-5">Level</span>
            </button>
          </div>
        </div>

        <div className="bg-[#393939] h-[109px] mt-8 pt-4">
